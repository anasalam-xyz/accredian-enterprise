...
export default function Hero() {
    return (
        ...
        >
            <div className="mx-4 md:mx-0 md:w-[45%]">
                <img src="/images/corporate-big-hero-v4.webp"/>
            </div>
            <div className="text-center md:text-left px-4 py-14 md:px-14 flex flex-col gap-6 md:gap-10 md:w-[55%]">
                <p className="mt-8 md:mt-0 text-2xl md:text-6xl font-medium">
                    Next-Gen <span className="text-blue-600">Expertise</span> 
                    &nbsp; for Your <span className="text-blue-600">Enterprise</span>
                </p>
                <p className="md:w-84 text-xs md:text-xl font-medium">Cultivate high-performance teams through expert learning.</p>
